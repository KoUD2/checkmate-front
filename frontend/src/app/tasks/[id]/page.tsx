...
function parseTask38Description(desc: string) {
	...
	for (const line of lines) {
		...
		else if (line.startsWith('Problem context: ')) problemFill = line.replace('Problem context: ', '')
		else if (line.startsWith('Opinion context: ')) opinionFill = line.replace('Opinion context: ', '')
	}
...
export default function TaskDetailPage() {
	...
	if (loading) return <div className={styles['page']}><p className={styles['status']}>Загрузка...</p></div>
			...
			<div className={styles['content']}>
						...
						<div className={styles['task-fields']}>
							...
							<div className={styles['instructions']}>
								<p className={styles['instruction-text']}>
									Write an email to Bill. In your message answer his questions, ask 3 questions about{' '}
									<input
										type='text'
						...
						<div className={styles['task-fields']}>
							...
							<div className={styles['plan']}>
								<p className={styles['plan-text']}>
									Write <span className={styles['plan-text--bold']}>200-250 words</span>.
									<br />Use the following plan:
								</p>
								<ul className={styles['plan-list']}>
									<li className={styles['plan-item']}>make an opening statement on the subject of the project;</li>
									<li className={styles['plan-item']}>select and report 2-3 facts;</li>
									<li className={styles['plan-item']}>make 1-2 comparisons where relevant and give your comments;</li>
									<li className={styles['plan-item']}>
										outline a problem that{' '}
										<input type='text' className={styles['inline-input']} value={task38.problemFill} disabled readOnly />{' '}
										and suggest a way of solving it;
									</li>
									<li className={styles['plan-item']}>
										conclude by giving and explaining your opinion on{' '}
										<input type='text' className={styles['inline-input']} value={task38.opinionFill} disabled readOnly />.
									</li>
								</ul>
							</div>
						</div>
				...
				<div className={styles['section']}>
					...
					<div className={styles['marks']}>
						{isTask37 ? (
							<>
								<Criteria maxMark={2} criteriaNumber='К1' criteriaDescription='Решение коммуникативной задачи' value={task.k1} readonly />
							...
							<>
								...
								<Criteria maxMark={3} criteriaNumber='К2' criteriaDescription='Организация текста' value={task.k2} readonly />
								<Criteria maxMark={3} criteriaNumber='К3' criteriaDescription='Лексика' value={task.k3} readonly />
								<Criteria maxMark={3} criteriaNumber='К4' criteriaDescription='Грамматика' value={task.k4 ?? 0} readonly />
								<Criteria maxMark={3} criteriaNumber='К5' criteriaDescription='Орфография и пунктуация' value={task.k5 ?? 0} readonly />
							</>
						)}
